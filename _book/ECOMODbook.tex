...
\KeywordTok{with}\NormalTok{(penguins,}\KeywordTok{interaction.plot}\NormalTok{(}\DataTypeTok{x.factor=}\NormalTok{species,}\DataTypeTok{trace.factor=}\NormalTok{sex,}\DataTypeTok{response=}\NormalTok{flipper_length_mm),}\DataTypeTok{ylab=}\StringTok{"Flipper length (mm)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{check_model}\NormalTok{(glmPoi)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{ECOMODbook_files/figure-latex/unnamed-chunk-16-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sponges <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"extfiles/1-s2.0-S1364815217301615-mmc2.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{with}\NormalTok{(sponges,}\KeywordTok{plot}\NormalTok{(long.sample,lat.sample)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{with}\NormalTok{(sponges,}\KeywordTok{plot}\NormalTok{(long.sample,lat.sample,}\DataTypeTok{cex=}\DecValTok{1}\OperatorTok{+}\NormalTok{species.richness}\OperatorTok{/}\KeywordTok{max}\NormalTok{(species.richness))) }
\end{Highlighting}
\end{Shaded}

\includegraphics{ECOMODbook_files/figure-latex/unnamed-chunk-19-2.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{with}\NormalTok{(sponges,}\KeywordTok{plot}\NormalTok{(long.sample,lat.sample,}\DataTypeTok{col=}\KeywordTok{ifelse}\NormalTok{(}\DecValTok{1}\OperatorTok{+}\NormalTok{species.richness}\OperatorTok{/}\KeywordTok{max}\NormalTok{(species.richness)}\OperatorTok{<}\FloatTok{1.5}\NormalTok{,}\StringTok{"red"}\NormalTok{,}\StringTok{"green"}\NormalTok{))) }
\end{Highlighting}
\end{Shaded}

\includegraphics{ECOMODbook_files/figure-latex/unnamed-chunk-19-3.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{corsponges=}\KeywordTok{cor}\NormalTok{(sponges)}
\NormalTok{corWithSSR=corsponges[,}\DecValTok{3}\NormalTok{]}
\KeywordTok{hist}\NormalTok{(corWithSSR[corWithSSR}\OperatorTok{!=}\DecValTok{1}\NormalTok{],}\DataTypeTok{main=}\StringTok{"Correlations between SSR and explanatory covariates"}\NormalTok{,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DataTypeTok{by=}\FloatTok{0.05}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{corsponges=}\KeywordTok{cor}\NormalTok{(sponges)}
\NormalTok{covars=corsponges[,}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)]}
\NormalTok{corcovars=}\KeywordTok{cor}\NormalTok{(covars)}
\KeywordTok{hist}\NormalTok{(corcovars[corcovars}\OperatorTok{!=}\DecValTok{1}\NormalTok{],}\DataTypeTok{main=}\StringTok{"Correlations between explanatory covariates (lat,long excluded)"}\NormalTok{,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DataTypeTok{by=}\FloatTok{0.05}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pairs}\NormalTok{(sponges[,}\KeywordTok{grep}\NormalTok{(}\DataTypeTok{pattern=}\StringTok{"bs"}\NormalTok{, }\DataTypeTok{x=}\KeywordTok{names}\NormalTok{(sponges),}\DataTypeTok{value =} \OtherTok{TRUE}\NormalTok{)[}\DecValTok{1}\OperatorTok{:}\DecValTok{14}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pairs}\NormalTok{(sponges[,}\KeywordTok{grep}\NormalTok{(}\DataTypeTok{pattern=}\StringTok{"bs"}\NormalTok{, }\DataTypeTok{x=}\KeywordTok{names}\NormalTok{(sponges),}\DataTypeTok{value =} \OtherTok{TRUE}\NormalTok{)[}\DecValTok{15}\OperatorTok{:}\DecValTok{28}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}

\includegraphics{ECOMODbook_files/figure-latex/unnamed-chunk-22-2.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pairs}\NormalTok{(sponges[,}\KeywordTok{grep}\NormalTok{(}\DataTypeTok{pattern=}\StringTok{"bs"}\NormalTok{, }\DataTypeTok{x=}\KeywordTok{names}\NormalTok{(sponges),}\DataTypeTok{value =} \OtherTok{TRUE}\NormalTok{)[}\DecValTok{29}\OperatorTok{:}\DecValTok{35}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}

\includegraphics{ECOMODbook_files/figure-latex/unnamed-chunk-22-3.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sort}\NormalTok{(}\KeywordTok{abs}\NormalTok{(}\KeywordTok{round}\NormalTok{(corWithSSR,}\DecValTok{2}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(sponges}\OperatorTok{$}\NormalTok{species.richness,}\DataTypeTok{xlab=}\StringTok{"Species Richness"}\NormalTok{,}\DataTypeTok{main=}\StringTok{""}\NormalTok{,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DataTypeTok{by=}\DecValTok{1}\NormalTok{))}
\KeywordTok{text}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{7}\NormalTok{,}\KeywordTok{paste0}\NormalTok{(}\StringTok{"Mean="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(sponges}\OperatorTok{$}\NormalTok{species.richness),}\DecValTok{1}\NormalTok{)))}
\KeywordTok{text}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{5}\NormalTok{,}\KeywordTok{paste0}\NormalTok{(}\StringTok{"Variance="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{var}\NormalTok{(sponges}\OperatorTok{$}\NormalTok{species.richness),}\DecValTok{1}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{1}\NormalTok{),}\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{4}\NormalTok{,}\FloatTok{0.5}\NormalTok{,}\FloatTok{0.5}\NormalTok{))}
\KeywordTok{hist}\NormalTok{(sponges}\OperatorTok{$}\NormalTok{species.richness,}\DataTypeTok{xlab=}\StringTok{"Species Richness"}\NormalTok{,}\DataTypeTok{main=}\StringTok{""}\NormalTok{,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DataTypeTok{by=}\DecValTok{5}\NormalTok{))}
\KeywordTok{text}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{20}\NormalTok{,}\KeywordTok{paste0}\NormalTok{(}\StringTok{"Mean="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(sponges}\OperatorTok{$}\NormalTok{species.richness),}\DecValTok{1}\NormalTok{)))}
\KeywordTok{text}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{10}\NormalTok{,}\KeywordTok{paste0}\NormalTok{(}\StringTok{"Variance="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{var}\NormalTok{(sponges}\OperatorTok{$}\NormalTok{species.richness),}\DecValTok{1}\NormalTok{)))}
\CommentTok{# Poisson}
\NormalTok{mean=}\DecValTok{10}
\KeywordTok{hist}\NormalTok{(}\KeywordTok{rpois}\NormalTok{(}\DecValTok{10000}\NormalTok{,mean),}\DataTypeTok{main=}\StringTok{""}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Poisson, mean=10"}\NormalTok{,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DataTypeTok{by=}\DecValTok{5}\NormalTok{))}
\CommentTok{#Neg Bin}
\NormalTok{mean=}\DecValTok{10}
\NormalTok{var=}\DecValTok{100}
\NormalTok{dat=}\KeywordTok{rnbinom}\NormalTok{(}\DecValTok{10000}\NormalTok{,}\DataTypeTok{size=}\NormalTok{mean}\OperatorTok{^}\DecValTok{2}\OperatorTok{/}\NormalTok{(var}\OperatorTok{-}\NormalTok{mean),}\DataTypeTok{mu=}\NormalTok{mean)}
\KeywordTok{hist}\NormalTok{(dat[dat}\OperatorTok{<}\DecValTok{40}\NormalTok{],}\DataTypeTok{main=}\StringTok{""}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Negative Binomial, mean=10, var=100"}\NormalTok{,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DataTypeTok{by=}\DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{with}\NormalTok{(sponges,}\KeywordTok{plot}\NormalTok{(dist.coast,species.richness))}
\NormalTok{lm0<-}\KeywordTok{lm}\NormalTok{(species.richness}\OperatorTok{~}\NormalTok{dist.coast,}\DataTypeTok{data=}\NormalTok{sponges)}
\KeywordTok{abline}\NormalTok{(lm0)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#testing a random variable!!}
\NormalTok{glmP1=}\KeywordTok{glm}\NormalTok{(species.richness}\OperatorTok{~}\NormalTok{dist.coast,}\DataTypeTok{family=}\KeywordTok{poisson}\NormalTok{(}\DataTypeTok{link=}\StringTok{"log"}\NormalTok{),}\DataTypeTok{data=}\NormalTok{sponges)}
\KeywordTok{library}\NormalTok{(MASS)}
\NormalTok{glmNB1=}\KeywordTok{glm.nb}\NormalTok{(species.richness}\OperatorTok{~}\NormalTok{dist.coast,}\DataTypeTok{link=}\NormalTok{log,}\DataTypeTok{data=}\NormalTok{sponges)}
\KeywordTok{AIC}\NormalTok{(glmP1,glmNB1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{glmQP1=}\KeywordTok{glm}\NormalTok{(species.richness}\OperatorTok{~}\NormalTok{dist.coast,}\DataTypeTok{family=}\NormalTok{quasipoisson,}\DataTypeTok{data=}\NormalTok{sponges)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(glmP1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(glmQP1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(glmNB1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{glmQP2=}\KeywordTok{glm}\NormalTok{(species.richness}\OperatorTok{~}\DecValTok{1}\NormalTok{,}\DataTypeTok{family=}\NormalTok{quasipoisson,}\DataTypeTok{data=}\NormalTok{sponges)}
\KeywordTok{anova}\NormalTok{(glmQP1,glmQP2, }\DataTypeTok{test =} \StringTok{"Chi"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{drop1}\NormalTok{(glmQP1,}\DataTypeTok{test=}\StringTok{"F"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{),}\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{4}\NormalTok{,}\FloatTok{0.5}\NormalTok{,}\FloatTok{0.5}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(glmP1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{),}\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{,}\DecValTok{4}\NormalTok{,}\FloatTok{0.5}\NormalTok{,}\FloatTok{0.5}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(glmNB1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{AIC}\NormalTok{(lm0,glmP1,glmNB1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{glmNB.}\FloatTok{0.15}\NormalTok{=}\KeywordTok{glm.nb}\NormalTok{(species.richness}\OperatorTok{~}\NormalTok{slope_o}\OperatorTok{+}\NormalTok{prof_cur5}\OperatorTok{+}\NormalTok{entro3 }
\OperatorTok{+}\NormalTok{rugosity7}\OperatorTok{+}\NormalTok{tpi3}\OperatorTok{+}\NormalTok{prof_cur7}\OperatorTok{+}\NormalTok{relief_}\DecValTok{3} 
\OperatorTok{+}\NormalTok{slope3}\OperatorTok{+}\NormalTok{tpi5}\OperatorTok{+}\NormalTok{plan_curv3}\OperatorTok{+}\NormalTok{slope5 }
\OperatorTok{+}\NormalTok{slope7}\OperatorTok{+}\NormalTok{relief_}\DecValTok{5}\OperatorTok{+}\NormalTok{relief_}\DecValTok{7}\OperatorTok{+}\NormalTok{long.sample }
\OperatorTok{+}\NormalTok{lat.sample}\OperatorTok{+}\NormalTok{gravel}\OperatorTok{+}\NormalTok{dist.coast}\OperatorTok{+}\NormalTok{sand,}\DataTypeTok{link=}\NormalTok{log,}\DataTypeTok{data=}\NormalTok{sponges)}
\end{Highlighting}
\end{Shaded}
